...
* **Favorites System:** Save your preferred stations with one click (★) for quick access.
* **Interactive Metadata Toasts:** See the currently playing song in an elegant, custom notification corner-popup. Click the ⛔ button on the toast to permanently blacklist annoying words (like "AD" or "News").
* **Dynamic Icons:** Automatically downloads and displays station logos (favicons) next to their names.
* **Highly Customizable:** ModMenu integration allows you to tweak volume, disable toasts, and manage your blacklist.

## ⚙️ Installation & Requirements
This is a **Client-Side only** mod. You do not need to install it on your server.
1. Install [Fabric Loader](https://fabricmc.net/).
2. Download and drop the `radio-mod-1.0.0.jar` into your `.minecraft/mods` folder.
