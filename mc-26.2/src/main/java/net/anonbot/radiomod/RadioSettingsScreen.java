    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(
                ...
                b -> { modClient.setShowToast(!modClient.isShowToast());
                    if (this.minecraft != null) this.minecraft.setScreenAndShow(new RadioSettingsScreen(modClient, parentScreen)); }
        ...
        this.addRenderableWidget(Button.builder(
                ...
                b -> { if (this.minecraft != null) this.minecraft.setScreenAndShow(new RadioBlacklistScreen(modClient, this)); }
        ...
        this.addRenderableWidget(Button.builder(
                ...
                b -> { if (this.minecraft != null) this.minecraft.setScreenAndShow(parentScreen); }
